...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2024 at 04:01 AM
...
INSERT INTO `annex` (`id_kamar`, `room_number`, `tersisa`, `bed`) VALUES
(4, 6, 4, 6);
...
INSERT INTO `crystal` (`id_kamar`, `room_number`, `tersisa`, `bed`) VALUES
(5, 2, 3, 4);
...
--
-- Table structure for table `edelweis`
--

CREATE TABLE `edelweis` (
  `id_kamar` int(6) NOT NULL,
  `room_number` int(4) NOT NULL,
  `tersisa` int(1) NOT NULL,
  `bed` int(1) NOT NULL
...
--
-- Dumping data for table `edelweis`
--

INSERT INTO `edelweis` (`id_kamar`, `room_number`, `tersisa`, `bed`) VALUES
(1, 2, 2, 4);
...
--
-- Dumping data for table `jasmine`
--

INSERT INTO `jasmine` (`id_kamar`, `room_number`, `tersisa`, `bed`) VALUES
(1, 4, 1, 4),
(3, 6, 4, 4);
...
('2024-11-13', 7, 2, 2, '00:00:02'),
('2024-11-19', 1, 2, 2, '10:36:13');
...
(123, 'jiba', 'Crystal', 7, '2024-11-13', '0000-00-00', 0, '', 790, '123@student.unklab.ac.id', 'jiba', 500000, 3000000, '');
...
--
ALTER TABLE `jasmine`
  MODIFY `id_kamar` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
